    ...
    <div className="w-1/4 min-w-[280px]  max-w-[260px] h-[calc(100vh-77px)] border-r border-r-greyVariant text-textColor  sticky top-[77px]">
      ...
      <ul className="p-6 pt-0 flex flex-col mt-8 gap-12 text-lightText ">
        ...
        <div>
          ...
          <div>
          <input type="range" className=" accent-textColor bg-bgDarker w-full h-2 rounded-lg appearance-none cursor-pointer " id="points" name="points" min="0" max="4"defaultValue={0} onChange={(e)=>{
            setCoursesFilter(filters=>{
